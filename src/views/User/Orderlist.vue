...
// /order-list -> ทั้งหมด, /order-list/ready-to-ship -> พร้อมส่ง, /order-list/preorder -> พรีออเดอร์
const orderTypeTabs = [
...
function matchOrderType(order, typeKey) {
  ...
  // "pending_import" คือรอบชำระค่านำเข้ารอบ 2 ของพรีออเดอร์ ถือเป็นพรีออเดอร์เช่นกัน
...
// จำนวนออเดอร์แต่ละประเภท ไว้แสดงเป็นตัวเลขบนแท็บ
...
<template>
  <div class="order-list-page">
    ...
    <div class="content">
      <!-- ── ORDER-TYPE FILTER: พร้อมส่ง / พรีออเดอร์ / ทั้งหมด ── -->
...
/* ── MOBILE NAV: HAMBURGER BUTTON (hidden on desktop, shown at max-width 768px) ── */
.navbar__hamburger {
  display: none;
