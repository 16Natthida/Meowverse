...
function formatOrderStatus(status) {
  const map = {
    ...
    Pending_import_fee: 'จ่ายค่านำเข้า',
...
function orderStatusClass(status) {
  const map = {
    ...
    Paid: 'status--paid',
    Pending_import_fee: 'status--Pending_import_fee',
...
.status--Pending_import_fee { background: #f0fdf4; color: #15803d; border-color: #bbf7d0; }
